/*
 * The stateless security code is taken from: 
 * https://github.com/Robbert1/boot-stateless-auth. This and some
 * other files in the security package.
 */
...
public final class TokenHandler {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 1000; i++) {
      final User user =
          new User(java.util.UUID.randomUUID().toString().substring(0, 8), new Date(
